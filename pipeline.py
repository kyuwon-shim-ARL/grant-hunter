...
# Allow running as: python3 -m pipeline or python3 pipeline.py
sys.path.insert(0, str(Path(__file__).parent))

from collectors.nih import NIHCollector
from collectors.eu_portal import EUPortalCollector
from collectors.grants_gov import GrantsGovCollector
from collectors.carb_x import CarbXCollector
from collectors.right_foundation import RightFoundationCollector
from collectors.gates_gc import GatesGCCollector
from collectors.pasteur_network import PasteurNetworkCollector
from collectors.google_org import GoogleOrgCollector
from collectors.base import BaseCollector
from eligibility import EligibilityEngine
from filters import filter_grants, diff_grants
from models import Grant
from report_generator import generate_html_report
from scoring import RelevanceScorer
from dashboard import generate_dashboard
from config import REPORT_EMAIL, SKIP_EMAIL_ON_FIRST_RUN, LOGS_DIR
